    ...
    <div class="col-md-10 offset-md-1">
        <form method="POST" action="{{ route('surl.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="url" required class="form-control" id="url" name="url" placeholder="{{__('surl::inputs.url_placeholder')}}" value="{{old('url')}}">
            </div>

            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="identifier">{{__('surl::inputs.identifier')}}</label>
                    <input type="text" class="form-control" id="identifier" aria-describedby="identifierHelp" name="identifier" placeholder="{{__('surl::inputs.identifier_placeholder')}}" value="{{old('identifier')}}">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="{{__('surl::inputs.title_placeholder')}}" value="{{old('title')}}">
                </div>
            </div>

            <div class="form-group">
                <label for="description">{{__('surl::inputs.description')}}</label>
                <input type="text" class="form-control" id="description" name="description" placeholder="{{__('surl::inputs.description_placeholder')}}" value="{{old('description')}}">
            </div>
